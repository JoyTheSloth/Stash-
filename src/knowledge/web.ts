...
app.listen(PORT, () => {
  ...
  {
    id: 'js_url_link_parsing',
    keywords: ['url', 'link', 'parse url', 'query string', 'extract links', 'parameter'],
    title: 'JavaScript URL Parsing & Query Parameter Extraction',
    category: 'Code',
    language: 'JavaScript',
    description: 'Utility methods for parsing URLs and extracting query strings in JavaScript/TypeScript.',
    content: `// 1. Get value of query parameter from URL
...
// 2. Extract all HTTP/HTTPS links from text block
